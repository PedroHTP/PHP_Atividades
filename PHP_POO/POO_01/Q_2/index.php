        ...
        class Triangulo {
            ...
            public function getArea(): string {
                if (!$this->ValidarTriangulo()) {
                    ...
                    return 'Triângulo válido!<br><br>Área: ' . $this->Area();
                }
            ...
            public function Area(): float {
                ...
                // formula de Heron
                $semi_perimentro = ($this->lado1 + $this->lado2 + $this->lado3) / 2;

                $area = $semi_perimentro * ($semi_perimentro - $this->lado1) * ($semi_perimentro - $this->lado2) * ($semi_perimentro - $this->lado3);
